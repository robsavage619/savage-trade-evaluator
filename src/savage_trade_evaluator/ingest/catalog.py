...
CATALOG: tuple[StatSource, ...] = (
    ...
    StatSource(
        ...
        target_table="statcast_batter_exitvelo_barrels",
        ingested=True,
    ...
    StatSource(
        ...
        target_table="statcast_sprint_speed",
        ingested=True,
    ...
    StatSource(
        ...
        era_start=2015,
        era_end=None,
        fetcher="savage_trade_evaluator.ingest.statcast_extended.ingest_catcher_poptime_year",
        primary_columns=(
            "pop_2b_sba",
            "pop_3b_sba",
            "exchange_2b_3b_sba",
        ...
        target_table="statcast_catcher_poptime",
        ingested=True,
        notes=(
            "Catcher throwing metrics: pop time to 2B/3B, exchange time, max-effort "
            "arm strength (mph). entity_id is MLBAM (no bridging). Pairs with "
            "catcher framing for the catcher dev-fit signal."
        ),
    ),
    StatSource(
        ...
        era_start=2016,
        era_end=None,
        fetcher="savage_trade_evaluator.ingest.statcast_extended.ingest_outfielder_jump_year",
        primary_columns=(
            "outs_above_average",
        ...
        target_table="statcast_outfielder_jump",
        ingested=True,
        notes=(
            "Outfielder dev signal — decomposes OAA into reaction / burst / routing "
            "distance vs league. resp_fielder_id is MLBAM (no bridging)."
        ),
    ),
    ...
    StatSource(
        ...
        target_table="statcast_pitch_movement",
        ingested=True,
        notes="Per-pitcher x pitch-type velocity / break / percentiles. 17,553 rows.",
    ),
